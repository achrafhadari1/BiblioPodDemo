...
export const EditBookModal = ({
  ...
  return (
    <div className="fixed min-h-screen inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto animate-fadeIn">
        <div className="p-6">
          {/* Modal Header */}
          ...
          <div className="flex gap-6">
            ...
            <div className="w-64 flex-shrink-0">
              ...
              <div className="relative">
                <div className="w-full h-80 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center bg-gray-50 hover:bg-gray-100 transition-colors">
                  {formData.thumbnail ? (
